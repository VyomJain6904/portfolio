...
export default function MobileDock({
	...
	return (
		<div className="fixed bottom-0 left-0 right-0 md:hidden flex flex-col items-center z-10 space-y-2">
			...
			<div className="mb-4 p-3 rounded-3xl space-x-4 flex justify-around items-center max-w-[400px] mx-auto">
				<button
			...
			<div className="mb-4 p-3 bg-gradient-to-t from-gray-700 to-gray-800 backdrop-blur-xl rounded-3xl space-x-4 flex justify-around items-center max-w-[400px] mx-auto">
