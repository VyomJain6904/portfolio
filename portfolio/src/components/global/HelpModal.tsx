...
export default function HelpModal({ isOpen, onClose, onTerminalClick }: HelpModalProps) {
	...
	const steps = [
		{
			...
			content:
				"This is a macOS-inspired portfolio with interactive features. Let me show you around!",
		...
		},
		{
			title: "The Terminal",
			content:
				"The MacTerminal is your AI-powered assistant. Ask it anything about me, my skills, or my experience!",
		...
		},
		{
			title: "Desktop Dock",
			content:
				"The dock at the bottom contains all the main features of my portfolio. Each icon represents a different section:",
		...
		},
		{
			title: "Menu Bar",
			content:
				"Use the menu bar to access my resume, projects, and contact information. Hover over my name for a cool surprise!",
